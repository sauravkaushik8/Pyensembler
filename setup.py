...
setup(
  ...
  url = 'https://github.com/sauravkaushik8/pyensembler',
  download_url = 'https://github.com/sauravkaushik8/pyensembler/archive/0.1.tar.gz',
  keywords = ['ensembling', 'stacking'],
  classifiers = [],
)
